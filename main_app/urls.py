...
urlpatterns = [
    ...
    path("admin/attendance/take/", hod_views.admin_take_attendance,
         name='admin_take_attendance'),
    path("admin/attendance/take/students/", hod_views.admin_get_students,
         name='admin_get_students'),
    path("admin/attendance/take/save/", hod_views.admin_save_attendance,
         name='admin_save_attendance'),
    ...
    path("parent/grant-role/", hod_views.grant_parent_role, name='grant_parent_role'),
    ...
    path("class/enrollment/manage/", hod_views.manage_secondary_enrollment,
         name='manage_secondary_enrollment'),
    ...
    path("staff/attendance/not-taken/", staff_views.staff_report_attendance_not_taken,
         name='staff_report_attendance_not_taken'),
    ...
    path("reports/attendance/not-taken/", hod_views.report_attendance_not_taken,
         name='report_attendance_not_taken'),
    path("reports/attendance/not-taken/csv/", hod_views.report_attendance_not_taken_csv,
         name='report_attendance_not_taken_csv'),
    path("reports/attendance/compliance/", hod_views.report_attendance_compliance,
         name='report_attendance_compliance'),
    path("reports/attendance/compliance/csv/", hod_views.report_attendance_compliance_csv,
         name='report_attendance_compliance_csv'),
